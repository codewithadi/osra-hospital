        ...
        <div className="depDetailContainer">
          <div className="depTextHead">
            ...
            <div className="depDetailAbout">
              Dentistry, the profession concerned with the prevention and
              treatment of oral disease, including diseases of the teeth and
              supporting structures and diseases of the soft tissues of the
              mouth.
              <br />
              <br />
              Dentistry is one of the best open access journals that aims to
              publish the most complete and reliable source of information on
              discoveries and current developments in the mode of original
              articles, review articles, case reports, short communications,
              etc. in this field and provide online access without any
              restrictions or subscriptions to researchers worldwide.
            </div>
          </div>
