    ...
    <div className="departments">
        ...
        <div className="depDetailContainer">
          <div className="depTextHead">
            ...
            <div className="depDetailAbout">
              ...
              is a complex, sophisticated system that regulates and coordinates
              body activities.A doctor who specializes in neurology is called a
              neurologist. The neurologist treats disorders that affect the
              brain, spinal cord, and nerves
              <br /> <br />
              The deparment offers the latest in neurological care with
              innovative therapies, new techniques and clinical trials developed
              by our world-class experts. Our neurologists help more than
              100,000 adults and children each year, including those with
      ...
      <div className="treatmentDetails">
        <div className="depMain">
          ...
          Our Neurology Department is dedicated to exceeding expectations. We provide cutting edge treatment of disorders below
          </p>
      ...
      <div className="depDoctors">
        <div className="depMain">
          ...
          <p className="depMainPara">
          Furthermore, the experts neurologist at Osra Hospital you may know:
          </p>
          <div className="depLine"></div>
        </div>
