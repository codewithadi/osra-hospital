            ...
            <div className='depDetail'>
                <div className='depDetailContainer'>
                    <div className='depTextHead'>
                        ...
                        <div className='depDetailAbout'>Radiology is a medical specialty that uses imaging to diagnose and treat diseases seen within the body. ... The radiology department may also be called the X-ray or imaging department</div>
                    ...
                    <div className='depImgWrapper'>
                        <img className="depDetailImg" src="/assets/images/radiology1.png" alt="radiology" />
                    </div>                    
                </div>
            </div>
                ...
                <div className='treatmentWrapper'>
                    <div className='treatmentCard'>
                        ...
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>CT scan Procedures</h2>
                    ...
                    <div className='treatmentCard'>
                        <div className='treatmentLogo'><img src="/assets/department/surgery.png" alt="anyimg" /></div>
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Ultrasound</h2>
                            <p className='treatmentAbout'>Dunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
                    ...
                    <div className='treatmentCard'>
                        ...
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Xray</h2>
                            <p className='treatmentAbout'>Dunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
