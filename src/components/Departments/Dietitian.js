            ...
            <div className='depDetail'>
                <div className='depDetailContainer'>
                    <div className='depTextHead'>
                        ...
                        <p className='depDetailPara'>A dietitian, medical dietitian, or dietician is an expert in identifying and treating disease-related malnutrition and in conducting medical nutrition therapy. A dietitian, medical dietitian, or dietician is an expert in identifying and treating disease-related malnutrition and in conducting medical nutrition therapy</p>
                    </div>
                ...
                <div className='treatmentWrapper'>
                    <div className='treatmentCard'>
                        ...
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Slimming and fitness programs</h2>
                    ...
                    <div className='treatmentCard'>
                        <div className='treatmentLogo'><img src="/assets/department/surgery.png" alt="anyimg" /></div>
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Obesity programs </h2>
                            <p className='treatmentAbout'>Dunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
                    ...
                    <div className='treatmentCard'>
                        ...
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Monitor the nutritional status of patients</h2>
                            <p className='treatmentAbout'>Dunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
                    ...
                    <div className='treatmentCard'>
                        <div className='treatmentLogo'><img src="/assets/department/surgery.png" alt="anyimg" /></div>
                        <div className='treatmentText'>
                            <h2 className='treatmentTitle'>Follow-up of the nutritional status of the patient after the operations</h2>
                            <p className='treatmentAbout'>Dunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
                </div>
