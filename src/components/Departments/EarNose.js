    ...
    <div className="departments">
        ...
        <div className="depDetailContainer">
          <div className="depTextHead">
            ...
            <div className="depDetailAbout">
              Surgical specialists who diagnose, evaluate and manage a wide
              range of diseases of the head and neck, including the ear, nose
              and throat regions are Otorhinolaryngologists (also known as
              otolaryngologists or ear, nose and throat or ENT Surgeons).
              <br />
              <br />
      ...
      <div className="treatmentDetails">
        <div className="depMain">
          ...
          The ENT Department is dedicated to exceeding expectations. We provide cutting edge treatment
          </p>
      ...
      <div className="depDoctors">
        <div className="depMain">
          ...
          <p className="depMainPara">
          The Osra Hospital ear, nose and throat (ENT) specialists are well-versed in the unique requirements of our diverse local population.
          </p>
          <div className="depLine"></div>
        </div>
