      ...
      <div className="depDetail">
        <div className="depDetailContainer">
          <div className="drTextHead">
            <div className="drDetailAbout">
              <div className="my-24 ml-4 md:ml-10">
                ...
                <div className="mt-20">
                  <span className="md:flex">
                    <h5 className="font-semibold">Qualification :</h5>
                    <p className="ml-1 mb-2 md:mb-0">
                      Master's degree in Psychiatry and neurology
                    </p>
                  </span>
                  <span className="md:flex mt-2">
                    <h5 className="font-semibold">Years of experience : </h5>
                    <p className="ml-1">14 years</p>
                  </span>
                </div>
