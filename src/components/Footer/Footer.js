...
function Footer() {
    ...
    return (
        <div
            className="md:pt-8 pt-4 text-white"
            style={{ background: "#3c0c1c" }}
        >
                            ...
                            <div className="grid grid-cols-1 md:gap-6 gap-2 sm:grid-cols-4 md:grid-cols-4 bg-transparent">
                                <div className="bg-transparent font-semibold">
                                    ...
                                    <Link
                                        onClick={scrollToTop}
                                        to="/"
                                        className="block mt-2 text-sm hover:text-blue-600 transition-colors duration-700 delay-100"
                                    >
                                        Home
                                    </Link>
                                    <Link
                                ...
                                <div className="bg-transparent font-semibold">
                                    ...
                                    <div className="block mt-2 text-sm  dark: bg-transparent">
                                        <div className="inline-flex md:pr-4 mb-2 hover:text-blue-600 transition-colors duration-700 delay-100">
                                            <svg
                                    ...
                                    <div className="block mt-2 text-sm hover:text-blue-600 transition-colors duration-700 delay-100">
